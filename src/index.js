...
import DeleteCourses from './facultycomponents/deletecourse';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/components/Mycourses" element={<MyCourse />} />
        <Route path="/facultycomponents/deletecourse" element={<DeleteCourses />} /> 
      </Routes>
    </BrowserRouter>
  );
}
