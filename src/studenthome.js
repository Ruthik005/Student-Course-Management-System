...
const HS2 = {"padding-right": "5px", "cursor": "pointer"};
const HS3 = {"height": "16px", "margin-top": "6px", "cursor": "pointer"};
const HS4 = {"padding-right": "10px"};
...
export function loadModule(smid) {
    ...
    switch (smid) {
        ...
        case "M00101":
            ...
            break;
        case "M00102":
            module.src = "/components/Mycourses";
        ...
        return (
            <div className='full-height'>
                <div className='header'>
                    <label style={HS1}>KL University | Student Course Management System</label>
